...
//  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, GPIO_PIN_SET);
	...
	******************************/
	...
	LCD_Send_Dat(0x1D);  // presceller(M=46) 
	...
	********************/
	...
	LCD_Send_Dat(0x01);     // Horizontal Width:  480 - 1 = 0x031F 
	LCD_Send_Dat(0xDF);
	...
	LCD_Send_Dat(0x02);    // HT: horizontal total period (display + non-display) – 1 = 520-1 =  519 =0x0207
	LCD_Send_Dat(0x13);
	LCD_Send_Dat(0x00);    // HPS: Horizontal Sync Pulse Start Position = Horizontal Pulse Width + Horizontal Back Porch = 16 = 0x10 
	LCD_Send_Dat(0x08);
	LCD_Send_Dat(0x2B);     // HPW: Horizontal Sync Pulse Width - 1=8-1=7 
	...
	LCD_Send_Dat(0x01);     // VT: Vertical Total (display + non-display) Period – 1  =647=0x287 
	LCD_Send_Dat(0x20);
	LCD_Send_Dat(0x00);     // VPS: Vertical Sync Pulse Start Position  =     Vertical Pulse Width + Vertical Back Porch = 2+2=4  
	LCD_Send_Dat(0x04);
	LCD_Send_Dat(0x0C);     //VPW: Vertical Sync Pulse Width – 1 =1 
